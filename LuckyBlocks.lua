-- =========================================================================
-- EMLOXA WARE: LUCKY BLOCKS BATTLEGROUNDS MAXIMUM POWER MODULE v3 (PREMIUM)
-- =========================================================================
local GameModule = {}
...
function GameModule:Init(Window)
    ...
    DupeTab:CreatePremiumButton("Start Dupe (Held Item)", function()
    ...
    KillerTab:CreatePremiumToggle("Enable Killer (Bring All)", function(state)
        KillerEnabled = state

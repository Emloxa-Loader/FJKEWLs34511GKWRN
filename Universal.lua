-- =========================================================================
-- EMLOXA WARE: UNIVERSAL MODULE (PREMIUM INTEGRATED)
-- =========================================================================
...
function UniversalModule:Init(Window)
    ...
    AimbotTab:CreatePremiumToggle("Enable Aimbot (Right Click)", function(s) AimbotEnabled = s end)
    ...
    PlayerTab:CreatePremiumToggle("Fly Hack", function(state)
        FlyEnabled = state
    ...
    VisualsTab:CreatePremiumToggle("ESP (Through Walls)", function(s) ESPEnabled = s end)

-- =========================================================================
-- EMLOXA WARE PREMIUM UI v15 (UNIVERSAL HYBRID ENGINE & EXPANDED API)
-- FULL STEALTH OBFUSCATED GUI | DEEP METATABLE SPOOFER | PREMIUM TOGGLE SUPPORT
-- STACKABLE TIME SUBSCRIPTION SYSTEM WITH WORKING DEVPRODUCTS
-- =========================================================================
local EmloxaLibrary = {}
...
function EmloxaLibrary:CreateWindow(hubName)
	...
	HubGui.Name = GenerateRandomString(32) -- Fully OBFUSCATED
	...
	-- Working Recharge Modal Builder
	...
	local function CreateTabInternal(tabName, layoutOrder)
		...
		-- Premium Styled Toggle Fix (Required for Evade and Special Game Modules)
		function TabSetup:CreatePremiumToggle(name, callback)
			...
			Badge.Position = UDim2.new(1, -120, 0.5, -9)

...
-- PHYSICS OVERRIDE: TRUE FLY & RAW SPEED INCLUDED | HYBRID PREMIUM SUPPORT
-- =========================================================================
local GameModule = {}
...
function GameModule:Init(Window)
    ...
    MoveTab:CreatePremiumToggle("Enable True Speed", function(s) Settings.Movement.SpeedEnabled = s end)
    MoveTab:CreateSlider("Speed Velocity Value", 16, 200, 40, function(v) Settings.Movement.SpeedValue = v end)
    MoveTab:CreatePremiumToggle("Enable Fly Mode", function(s) Settings.Movement.FlyEnabled = s end)
    ...
    CarryTab:CreatePremiumToggle("Enable Auto Carry Loop", function(s) 
    ...
    ExploitTab:CreatePremiumToggle("Auto Revive Aura (Lag-Free)", function(s) Settings.Exploits.AutoReviveAura = s end)
    ExploitTab:CreatePremiumToggle("Auto Revive Loop (Self)", function(s) Settings.Exploits.AutoReviveSelf = s end)
    ...
    ExploitTab:CreatePremiumToggle("Loop TP to Nextbot", function(s) 
    ...
    EspTab:CreatePremiumToggle("NextBots ESP", function(s) Settings.Visuals.BotESP = s
        if not s then

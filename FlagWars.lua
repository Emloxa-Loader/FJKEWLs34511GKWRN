-- =========================================================================
-- EMLOXA WARE: FLAG WARS TACTICAL CORE v3 (PREMIUM)
-- =========================================================================
local GameModule = {}
...
function GameModule:Init(Window)
    ...
    CombatTab:CreatePremiumToggle("Enable Aimbot", function(s) AimbotEnabled = s end)
    ...
    local HitboxSize = 2
    HitboxTab:CreatePremiumToggle("Enable Hitbox", function(s) HitboxEnabled = s end)
    ...
    ESPTab:CreatePremiumToggle("Enable ESP", function(s) ESPEnabled = s end)

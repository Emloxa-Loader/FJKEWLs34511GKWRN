-- ==========================================
-- EMLOXA WARE UI LIBRARY v5 (Click-Through Fix & Credits)
-- ==========================================
local EmloxaLibrary = {}
...
function EmloxaLibrary:CreateWindow(hubName)
    ...
    OpenIcon.Active = true -- Tıklama geçmesini engeller
    ...
    -- MAIN FRAME (Arkaya tıklamayı engelleyen en önemli yer)
    ...
    MainFrame.Active = true -- Arkaya tıklamayı engeller
    ...
    -- Sürükleme Mantığı (Oyun kamerasına tıklamayı engeller)
    ...
    function WindowSetup:ShowDiscordPrompt()
        ...
        PromptFrame.Position = UDim2.new(1, 20, 1, -140)
        ...
        PTitle.Font = Enum.Font.GothamBold; PTitle.TextSize = 16; PTitle.TextColor3 = Color3.fromRGB(102, 85, 255)
        PTitle.Size = UDim2.new(1, -20, 0, 30); PTitle.Position = UDim2.new(0, 10, 0, 5); PTitle.BackgroundTransparency = 1
        PTitle.TextXAlignment = Enum.TextXAlignment.Left; PTitle.Parent = PromptFrame
        ...
        PDesc.Font = Enum.Font.Gotham; PDesc.TextSize = 13; PDesc.TextColor3 = Color3.fromRGB(200, 200, 200)
        PDesc.Size = UDim2.new(1, -20, 0, 40); PDesc.Position = UDim2.new(0, 10, 0, 35); PDesc.BackgroundTransparency = 1
        PDesc.TextXAlignment = Enum.TextXAlignment.Left; PDesc.TextWrapped = true; PDesc.Parent = PromptFrame

        local BtnYes = Instance.new("TextButton")
        BtnYes.Size = UDim2.new(0, 140, 0, 30); BtnYes.Position = UDim2.new(0, 10, 1, -40)
        BtnYes.BackgroundColor3 = Color3.fromRGB(102, 85, 255); BtnYes.Text = "Copy Link"
        BtnYes.Font = Enum.Font.GothamBold; BtnYes.TextColor3 = Color3.fromRGB(255, 255, 255); BtnYes.TextSize = 12
        BtnYes.Parent = PromptFrame; Instance.new("UICorner", BtnYes).CornerRadius = UDim.new(0, 6)

        local BtnNo = Instance.new("TextButton")
        BtnNo.Size = UDim2.new(0, 140, 0, 30); BtnNo.Position = UDim2.new(1, -150, 1, -40)
        BtnNo.BackgroundColor3 = Color3.fromRGB(30, 30, 35); BtnNo.Text = "No Thanks"
        BtnNo.Font = Enum.Font.Gotham; BtnNo.TextColor3 = Color3.fromRGB(150, 150, 150); BtnNo.TextSize = 12
        BtnNo.Parent = PromptFrame; Instance.new("UICorner", BtnNo).CornerRadius = UDim.new(0, 6)
        ...
        BtnYes.MouseButton1Click:Connect(function()
            if setclipboard then setclipboard("https://discord.gg/XjfW7N84jT"); BtnYes.Text = "Copied!"; BtnYes.BackgroundColor3 = Color3.fromRGB(40, 200, 100) else BtnYes.Text = "Error" end
    ...
    function WindowSetup:CreateTab(tabName)
        ...
        TabBtn.Size = UDim2.new(0, 120, 1, 0); TabBtn.Text = tabName; TabBtn.Font = Enum.Font.GothamSemibold
        TabBtn.TextSize = 14; TabBtn.TextColor3 = Color3.fromRGB(150, 150, 150); TabBtn.BackgroundTransparency = 1; TabBtn.Parent = TabContainer

        local Indicator = Instance.new("Frame")
        Indicator.Size = UDim2.new(0, 0, 0, 2); Indicator.Position = UDim2.new(0.5, 0, 1, -2)
        Indicator.BackgroundColor3 = Color3.fromRGB(102, 85, 255); Indicator.BorderSizePixel = 0; Indicator.Parent = TabBtn

        local PageScroll = Instance.new("ScrollingFrame")
        PageScroll.Size = UDim2.new(1, 0, 1, 0); PageScroll.BackgroundTransparency = 1
        PageScroll.BorderSizePixel = 0; PageScroll.ScrollBarThickness = 3
        PageScroll.Active = true -- Kaydırma yaparken arkaya tıklanmasın
        PageScroll.Visible = false; PageScroll.Parent = PageContainer

        local PageLayout = Instance.new("UIListLayout")
        PageLayout.SortOrder = Enum.SortOrder.LayoutOrder; PageLayout.Padding = UDim.new(0, 10); PageLayout.Parent = PageScroll
        ...
        function TabSetup:CreateToggle(name, callback)
            ...
            Label.Size = UDim2.new(1, -70, 1, 0); Label.Position = UDim2.new(0, 15, 0, 0); Label.Text = name
            Label.Font = Enum.Font.Gotham; Label.TextSize = 14; Label.TextColor3 = Color3.fromRGB(220, 220, 220)
            Label.TextXAlignment = Enum.TextXAlignment.Left; Label.BackgroundTransparency = 1; Label.Parent = ToggleFrame

            local Btn = Instance.new("TextButton")
            Btn.Size = UDim2.new(0, 46, 0, 24); Btn.Position = UDim2.new(1, -60, 0.5, -12); Btn.BackgroundColor3 = Color3.fromRGB(50, 50, 55)
            Btn.Text = ""; Btn.Parent = ToggleFrame; Instance.new("UICorner", Btn).CornerRadius = UDim.new(1, 0)

            local Circle = Instance.new("Frame")
            Circle.Size = UDim2.new(0, 18, 0, 18); Circle.Position = UDim2.new(0, 3, 0.5, -9)
        ...
        function TabSetup:CreateSlider(name, min, max, default, callback)
            ...
            SliderFrame.Size = UDim2.new(1, -10, 0, 60); SliderFrame.BackgroundColor3 = Color3.fromRGB(30, 30, 35)
            ...
            local Label = Instance.new("TextLabel")
            Label.Size = UDim2.new(1, -30, 0, 25); Label.Position = UDim2.new(0, 15, 0, 5); Label.Text = name
            Label.Font = Enum.Font.Gotham; Label.TextSize = 14; Label.TextColor3 = Color3.fromRGB(220, 220, 220)
            Label.TextXAlignment = Enum.TextXAlignment.Left; Label.BackgroundTransparency = 1; Label.Parent = SliderFrame

            local ValueText = Instance.new("TextLabel")
            ValueText.Size = UDim2.new(0, 40, 0, 25); ValueText.Position = UDim2.new(1, -55, 0, 5); ValueText.Text = tostring(default)
            ValueText.Font = Enum.Font.GothamBold; ValueText.TextSize = 14; ValueText.TextColor3 = Color3.fromRGB(102, 85, 255)
            ValueText.TextXAlignment = Enum.TextXAlignment.Right; ValueText.BackgroundTransparency = 1; ValueText.Parent = SliderFrame

            local Bar = Instance.new("TextButton")
            Bar.Size = UDim2.new(1, -30, 0, 6); Bar.Position = UDim2.new(0, 15, 0, 40); Bar.BackgroundColor3 = Color3.fromRGB(50, 50, 55)
            Bar.Text = ""; Bar.Parent = SliderFrame; Instance.new("UICorner", Bar).CornerRadius = UDim.new(1, 0)

            local Fill = Instance.new("Frame")
            local defaultPercent = (default - min) / (max - min)
            Fill.Size = UDim2.new(defaultPercent, 0, 1, 0); Fill.BackgroundColor3 = Color3.fromRGB(102, 85, 255)
            Fill.Parent = Bar; Instance.new("UICorner", Fill).CornerRadius = UDim.new(1, 0)
        ...
        function TabSetup:CreateButton(name, callback)
            local Btn = Instance.new("TextButton")
            Btn.Size = UDim2.new(1, -10, 0, 40); Btn.BackgroundColor3 = Color3.fromRGB(30, 30, 35)

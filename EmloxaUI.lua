-- ==========================================
-- EMLOXA WARE ULTRA UI v6 (Premium Edition)
-- ==========================================
local UltraLibrary = {}
...
local Theme = {
	...
	PrimaryDark = Color3.fromRGB(90, 70, 220),
	Background = Color3.fromRGB(16, 16, 22),
	Panel = Color3.fromRGB(26, 26, 32),
	PanelLight = Color3.fromRGB(34, 34, 40),
	Accent = Color3.fromRGB(255, 100, 100),
	TextColor = Color3.fromRGB(240, 240, 250),
	SubTextColor = Color3.fromRGB(170, 170, 180),
	GradientStart = Color3.fromRGB(120, 100, 255),
	GradientEnd = Color3.fromRGB(70, 150, 255),
}
...
local function createShadow(parent, size, offset, transparency)
	...
	shadow.Image = "rbxassetid://6014261993" -- default Roblox dropshadow
	shadow.ScaleType = Enum.ScaleType.Slice
	shadow.SliceCenter = Rect.new(49, 49, 49, 49)
	shadow.Size = size or UDim2.new(1, 20, 1, 20)
	shadow.Position = UDim2.new(0, offset or -10, 0, offset or -10)
...
local function playClickSound()
	-- Simulate click sound with a very quick tween on a fake button (not real audio)
	local soundFrame = Instance.new("Frame")
	soundFrame.Size = UDim2.new(0,0,0,0)
	soundFrame.Parent = CoreGui
	TweenService:Create(soundFrame, TweenInfo.new(0.05, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Size = UDim2.new(0,1,0,1)}):Play()
	task.wait(0.05)
	soundFrame:Destroy()
end

function UltraLibrary:CreateWindow(hubName)
	local WindowSetup = {}

	local HubGui = Instance.new("ScreenGui")
	HubGui.Name = "EmloxaUltraUI"
	HubGui.ResetOnSpawn = false
	HubGui.IgnoreGuiInset = true

	local success, _ = pcall(function() HubGui.Parent = CoreGui end)
	...
	RunService.RenderStepped:Connect(function()
		...
		OpenIcon.TextColor3 = Color3.fromHSV(hue, 0.8, 1)
		iconStroke.Color = Color3.fromHSV(hue, 0.9, 1)
	end)
	...
	for i = 1, 8 do
		...
		RunService.RenderStepped:Connect(function()
			...
			dot.BackgroundTransparency = 0.3 + math.sin(t)*0.3
		end)
	end

	local LoadText = Instance.new("TextLabel")
	LoadText.Text = "EMLOXA WARE ULTRA"
	...
	RunService.RenderStepped:Connect(function()
		...
		LoadText.TextColor3 = Color3.fromHSV(hue, 0.9, 1)
	end)
	...
	CreditsText.Size = UDim2.new(0, 140, 1, 0)
	...
	OpenIcon.MouseButton1Click:Connect(function()
		...
		animateWindow(isMinimized and UDim2.new(0, 650, 0, 50) or UDim2.new(0, 650, 0, 460))
		TweenService:Create(MainFrame, TweenInfo.new(0.45, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Size = UDim2.new(0, 650, 0, 460)}):Play()
	end)

	-- Dragging with smooth rubber band effect
	...
	RunService.RenderStepped:Connect(function()
		if dragging and dragInput then
			...
			MainFrame.Position = UDim2.new(0, currentX + (targetX - currentX) * 0.3, 0, currentY + (targetY - currentY) * 0.3)
		end
	end)
	...
	function WindowSetup:ShowDiscordPrompt()
		...
		PDesc.Text = "En güncel scriptler ve destek için sunucumuza katıl!"
		PDesc.Font = Enum.Font.Gotham; PDesc.TextSize = 13; PDesc.TextColor3 = Theme.TextColor
		...
		BtnYes.BackgroundColor3 = Theme.Primary; BtnYes.Text = "Linki Kopyala"
		...
		BtnNo.BackgroundColor3 = Theme.PanelLight; BtnNo.Text = "Hayır Teşekkürler"
		...
		BtnYes.MouseButton1Click:Connect(function()
			...
			BtnYes.Text = "Kopyalandı!"; BtnYes.BackgroundColor3 = Color3.fromRGB(40,200,100)
	...
	-- Tab Creation with animated indicator
	function WindowSetup:CreateTab(tabName)
		local TabSetup = {}

		local TabBtn = Instance.new("TextButton")
		TabBtn.Size = UDim2.new(0, 130, 1, 0); TabBtn.Text = tabName
		TabBtn.Font = Enum.Font.GothamBold; TabBtn.TextSize = 15
		TabBtn.TextColor3 = Theme.SubTextColor; TabBtn.BackgroundTransparency = 1
		TabBtn.Parent = TabContainer

		local Indicator = Instance.new("Frame")
		Indicator.Size = UDim2.new(0, 0, 0, 3); Indicator.Position = UDim2.new(0.5, 0, 1, -3)
		Indicator.BackgroundColor3 = Theme.Primary; Indicator.BorderSizePixel = 0
		Indicator.Parent = TabBtn

		local PageScroll = Instance.new("ScrollingFrame")
		PageScroll.Size = UDim2.new(1, 0, 1, 0); PageScroll.BackgroundTransparency = 1
		PageScroll.BorderSizePixel = 0; PageScroll.ScrollBarThickness = 4
		PageScroll.ScrollBarImageColor3 = Theme.Primary
		PageScroll.Active = true; PageScroll.Visible = false
		...
		-- Auto-resize canvas when children added
		...
		function TabSetup:CreateDropdown(name, options, default, callback)
			...
			Label.Font = Enum.Font.GothamSemibold; Label.TextSize = 14; Label.TextColor3 = Theme.TextColor
			Label.TextXAlignment = Enum.TextXAlignment.Left; Label.BackgroundTransparency = 1
			Label.Parent = DropdownFrame

			local ToggleBtn = Instance.new("TextButton")
			ToggleBtn.Size = UDim2.new(1, 0, 0, 48); ToggleBtn.BackgroundTransparency = 1; ToggleBtn.Text = ""
			...
			UIListLayout.SortOrder = Enum.SortOrder.LayoutOrder; UIListLayout.Parent = OptionContainer
			...
			for _, option in ipairs(options) do
				...
				OptBtn.Size = UDim2.new(1, 0, 0, 34); OptBtn.BackgroundColor3 = Theme.Panel
				OptBtn.Text = "  " .. option; OptBtn.Font = Enum.Font.Gotham; OptBtn.TextSize = 13
				OptBtn.TextColor3 = Theme.SubTextColor; OptBtn.TextXAlignment = Enum.TextXAlignment.Left
		...
		function TabSetup:CreateToggle(name, callback)
			...
			ToggleFrame.Size = UDim2.new(1, 0, 0, 50); ToggleFrame.BackgroundColor3 = Theme.PanelLight
			...
			Btn.Size = UDim2.new(0, 50, 0, 26); Btn.Position = UDim2.new(1, -65, 0.5, -13); Btn.BackgroundColor3 = Theme.Panel
			Btn.Text = ""; Btn.Parent = ToggleFrame; createCorner(Btn, 13)
		...
		function TabSetup:CreateSlider(name, min, max, default, callback)
			...
			SliderFrame.Size = UDim2.new(1, 0, 0, 65); SliderFrame.BackgroundColor3 = Theme.PanelLight
			...
			ValueText.Font = Enum.Font.GothamBold; ValueText.TextSize = 14; ValueText.TextColor3 = Theme.Primary
			ValueText.TextXAlignment = Enum.TextXAlignment.Right; ValueText.BackgroundTransparency = 1; ValueText.Parent = SliderFrame

			local Bar = Instance.new("TextButton")
			Bar.Size = UDim2.new(1, -30, 0, 8); Bar.Position = UDim2.new(0, 15, 0, 42); Bar.BackgroundColor3 = Theme.Panel
			Bar.Text = ""; Bar.Parent = SliderFrame; createCorner(Bar, 4)

			local Fill = Instance.new("Frame")
			local defaultPercent = (default - min) / (max - min)
			Fill.Size = UDim2.new(defaultPercent, 0, 1, 0); Fill.BackgroundColor3 = Theme.Primary
			Fill.Parent = Bar; createCorner(Fill, 4)
		...
		function TabSetup:CreateButton(name, callback)
			local Btn = Instance.new("TextButton")
			Btn.Size = UDim2.new(1, 0, 0, 42); Btn.BackgroundColor3 = Theme.PanelLight
			Btn.Text = name; Btn.Font = Enum.Font.GothamBold; Btn.TextSize = 15; Btn.TextColor3 = Theme.TextColor
		...
		function TabSetup:CreateNotification(title, message, duration)
			...
			TitleLabel.TextColor3 = Theme.Primary; TitleLabel.Size = UDim2.new(1, -20, 0, 22); TitleLabel.Position = UDim2.new(0, 10, 0, 8)
			...
			MsgLabel.TextColor3 = Theme.TextColor; MsgLabel.Size = UDim2.new(1, -20, 0, 30); MsgLabel.Position = UDim2.new(0, 10, 0, 32)
			MsgLabel.BackgroundTransparency = 1; MsgLabel.TextXAlignment = Enum.TextXAlignment.Left
			MsgLabel.TextWrapped = true; MsgLabel.Parent = Notif

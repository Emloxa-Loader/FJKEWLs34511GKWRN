-- =========================================================================
-- EMLOXA WARE: ONE TAP V2 (ULTIMATE NPC & PLAYER HYBRID CORE - PREMIUM)
-- =========================================================================
local GameModule = {}
...
function GameModule:Init(Window)
    ...
    CombatTab:CreatePremiumToggle("RageBot (Auto Lock)", function(s) Settings.Combat.RageBot = s end)
    CombatTab:CreatePremiumToggle("TriggerBot (Auto Shoot on Crosshair)", function(s) Settings.Combat.TriggerBot = s end)
    
    CombatTab:CreateToggle("Only Lock Real Players", function(s) Settings.Combat.RealPlayersOnly = s end)
    CombatTab:CreatePremiumToggle("Wall Check (Duvar Arkası Vurma)", function(s) Settings.Combat.WallCheck = s end)
    
    CombatTab:CreateDropdown("Target Part", {"Head", "HumanoidRootPart", "UpperTorso"}, "Head", nil, function(v) Settings.Combat.TargetPart = v end)
    ...
    LocalTab:CreatePremiumToggle("SpinBot (Mevlana)", function(s) Settings.Misc.SpinBot = s end)
